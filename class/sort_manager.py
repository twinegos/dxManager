...
class SortManager:
    ...
    def sort_by_taskName(self):
        ...
        self.main_window.set_listView_view(self.main_window.shotListview, self.main_window.shotListview.model())
    ...
    def sortScheduleListview(self, listview, model, sortOrder, sortColumn, date=None):
        ...
        if source_model != None:
            ...
            self.main_window.set_listView_view(listview, source_model)